...
* Are you going to publish? Please acknowledge the use of my code in any publication referencing:
   ...
   ``Amarante, A., Winter, O. C., Sfair, R. (2021). Stability and Evolution of Fallen Particles Around the Surface of Asteroid (101955) Bennu. JGR Planets.``
...
The code was used in the following studies:

* L. Braga, A. Amarante, A. Ferreira, F. Monteiro, and M. Martins (2026). Surface Properties, Orbital Dynamics, and Thermophysical Modeling of the Primitive Asteroid (269) Justitia. PSJ.
* A.K. de Almeida Jr., A.F.S. Ferreira, L.B.T. Santos, F. Monteiro, A. Amarante, E. Tresaco, D.M. Sanchez, C. Gomes, A.F.B. Prado (2026). A generalized dipole-segment model for the gravitational field of elongated bodies. A&A.
* A.K. de Almeida Jr., L.B.T. Santos, C.E.S. Gomes, E.V.M. Andrade, A.L.S. Barros, K.G.F. Santos, G.M. Fernandes, F. Monteiro, A. Amarante, R.I.S. Bastos, N.B. Lima, H.C.B. Nascimento, N.B.D. Lima, and A.F.B.A. Prado (2026). Equilibrium points and stability analysis in binary asteroid systems using a double mass dipole model. ASR.
* A. Martin, O.C. Winter, R. Sfair, and A. Amarante (2025). Revisiting (16) Psyche: implications of the new shape model for its surface and surrounding. EPJ - Special Topics.
* L. Braga, A. Amarante, A. Ferreira, C. Gomes, and L. Ceranto (2025). Equilibrium points and surface dynamics about comet 67P/Churyumov-Gerasimenko. EPJ - Special Topics.
* Hangbin Jo, Masateru Ishiguro, Derek C. Richardson, Sean E. Marshall, Tomoko Arai, and Ko Ishibashi (2024). The surface dynamics and geophysical environment of asteroid (3200) Phaethon. A&A.
* Amarante, A., Winter, O. C., Sfair, R. (2021). Stability and Evolution of Fallen Particles Around the Surface of Asteroid (101955) Bennu. JGR Planets.
